...
export default {
  ...
  jwt: {
    ...
    accessExpirationMinutes: envVars.JWT_ACCESS_EXPIRATION_MINUTES || 600,
    refreshExpirationDays: envVars.JWT_REFRESH_EXPIRATION_DAYS || 30,
    resetPasswordExpirationMinutes: envVars.JWT_RESET_PASSWORD_EXPIRATION_MINUTES || 6000,
    verifyEmailExpirationMinutes: envVars.JWT_VERIFY_EMAIL_EXPIRATION_MINUTES || 300,
  },
  email: {
    smtp: {
